package br.com.lixozen.lixo.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests(auth -> auth
                        .requestMatchers("/coletas/**").authenticated()
                        .requestMatchers("/alertas/**").authenticated()
                        .requestMatchers("/pontos-coleta/**").authenticated()
                        .requestMatchers("/relatorios/**").authenticated()
                        .requestMatchers("/tipos-residuo/**").authenticated()
